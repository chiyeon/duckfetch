...
async function start() {
	var help = process.argv.some(e => /^-\b.*h.*$/.test(e)) || process.argv.includes("--help")
	var flatten = process.argv.some(e => /^-\b.*f.*$/.test(e)) || process.argv.includes("--flatten")
	var shortened = process.argv.some(e => /^-\b.*s.*$/.test(e)) || process.argv.includes("--simple")
	var center = process.argv.some(e => /^-\b.*c.*$/.test(e)) || process.argv.includes("--center")
